...
public class NewsEntryResource {
	...
	@Path("{name}")
	public List<BlogPost> getByCategories(@PathParam("name") String categoryName) {
		this.logger.info("read(name)");
		return this.blogPostService.getPostsByCategory(categoryName);
	}
